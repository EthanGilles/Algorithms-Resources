...
\SetRowColor{LightBackground}
\mymulticolumn{1}{x{8.4cm}}{\verb|git branch -m [existing-branch] [new-branch]| \newline
Rename the specified branch at the current commit} \tn 
...
\begin{tabularx}{8.4cm}{X}
\SetRowColor{DarkBackground}
\mymulticolumn{1}{x{8.4cm}}{\bf\textcolor{white}{Temporary Commits}}  \tn

\SetRowColor{white}
\mymulticolumn{1}{x{8.4cm}}{\verb|git stash| \newline 
Save modified and staged changes in a stack} \tn 

\SetRowColor{LightBackground}
\mymulticolumn{1}{x{8.4cm}}{\verb|git stash list| \newline 
List stack-order of stashed file changes} \tn 

\SetRowColor{white}
\mymulticolumn{1}{x{8.4cm}}{\verb|git stash pop| \newline
Write the working changes from the top of the stash stack} \tn 

\SetRowColor{LightBackground}
\mymulticolumn{1}{x{8.4cm}}{\verb|git stash drop| \newline 
Discard the working changes from the top of the stash stack} \tn 
